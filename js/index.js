...
function fetchWeatherData() {
    fetch(`https://api.weatherstack.com/current?access_key=YOUR_ACCESS_KEY&query=New York
    `)
        ...
        .then(data => {
            ...
            if (code == 1000) {
                ...
                app.style.backgroundImage = `url(.imgs/${timeOfday}/Rainy.jpg)`;
                ...
                app.style.backgroundImage = `url(./imgs/${timeOfDay}/nowy.jpg)`;
        ...
        .catch(() => {
            alert('ქალაქი არ მოიძებნება, გთხოვთ ცადოთ თავიდან');
            app.style.opacity = "1";
        });
}
